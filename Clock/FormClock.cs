...
public partial class FormClock : Form
{
    ...
    private readonly Pen second_pen = new (Color.Red, 4);
    private readonly Pen miniute_pen = new (Color.Red, 4);
    private readonly Pen hour_pen = new (Color.Yellow, 6);
    const int r_second = 140;
    const int r_miniute = 120;
    const int r_hour = 80;
    private readonly Pen a = new (Color.White , 1);
    const int r_a = 160;
    const int r_b = 90;
    const int r_c = 120;

    //private int b = 0;
    private readonly Font font = new (FontFamily.GenericSansSerif,
    ...
    private void Timer_Tick(object sender, EventArgs e)
    {
        ...
        using (var g = this.CreateGraphics())
        {
            ...
            g.DrawRectangle(Pens.AliceBlue, x0 - 150, 570, 350, 75);
            ...
            string text = ct.Hour >= 12 ? $"{ct.Hour-12:D2}:{ct.Minute:D2}:{ct.Second:D2} PM" : $"{ct.Hour:D2}:{ct.Minute:D2}:{ct.Second:D2} AM";
            g.DrawString(text, font, Brushes.Black, new PointF(x0 - 136, 575));
